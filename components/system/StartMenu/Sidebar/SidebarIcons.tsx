...
export const Language = memo(() => (
  <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
    <path d="M16 0C7.2 0 0 7.2 0 16s7.2 16 16 16 16-7.2 16-16S24.8 0 16 0zm0 2c3.6 0 6.9 1.3 9.5 3.5h-4.2c-1.3 1.8-2.3 3.8-3 6H8.5c1.5-4.2 4.2-7.5 7.5-9.5zm0 28c-3.3 0-6.3-2.2-8.3-5.5h6.3c.7 1.8 1.7 3.5 3 5.1-.3.2-.7.4-1 .4zm3-5.5c.6 1.3 1.4 2.5 2.3 3.6C19.9 27.3 18.1 27.5 16 27.5c1.2-1.2 2.2-2.7 3-4.5zm-10.5-1.5C7.2 20.6 6.5 18.4 6.5 16c0-1.2.2-2.3.5-3.5h18c.3 1.2.5 2.3.5 3.5 0 2.4-.7 4.6-2 6.5H8.5zM9.5 11c1-2.2 2.3-4.1 3.8-5.5C11.5 7 10.3 8.9 9.5 11zm12 0c.7-1.8 1.7-3.5 3-5.1.3-.2.7-.4 1-.4-1.4 1.2-2.6 3.1-3.5 5.5h-.5zM2 16C2 8.3 8.3 2 16 2c-3.3 2-6 5.3-7.5 9.5H2.5C2.2 12.7 2 14.3 2 16zm27.5-4.5H22c.7-2.2 1.7-4.1 3-5.5-1.8 1.4-3.3 3.3-4.5 5.5h1z" />
  </svg>
));